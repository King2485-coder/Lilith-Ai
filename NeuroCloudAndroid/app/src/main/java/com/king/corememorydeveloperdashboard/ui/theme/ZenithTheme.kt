...
private val ZenithDarkColorScheme = darkColorScheme(
...
private val ZenithLightColorScheme = lightColorScheme(
...
fun ZenithTheme(
    ...
    val colorScheme = if (darkTheme) ZenithDarkColorScheme else ZenithLightColorScheme
